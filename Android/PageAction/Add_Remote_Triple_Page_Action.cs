...
[assembly: Dependency (typeof (Add_Remote_Triple_Page_Action))]
namespace HomeZig.Android
{
	public class Add_Remote_Triple_Page_Action : ContentPage, I_Add_Remote_Triple
	{
		public Add_Remote_Triple_Page_Action ()
		{
		}

		public async void submitRemoteButton_Click(object sender, EventArgs e)
		{
			if (String.IsNullOrEmpty (Add_Remote_Triple_Page.instructionRemoteName_value.Text)) {
				...
				rd.ID = 0;
				rd.node_addr = Add_Remote_Triple_Page.item.node_addr;
				rd.remote_button_name = Add_Remote_Triple_Page.instructionRemoteName_value.Text;
				rd.remote_code = "triple";
				...
				Device.BeginInvokeOnMainThread (() => {
					Add_Remote_Triple_Page.addRemotePageLayout.Children.Add (Add_Remote_Triple_Page.plsWaitText);
					Add_Remote_Triple_Page.plsWaitText.TextColor = Color.Default;
					Add_Remote_Triple_Page.plsWaitText.Text = "Push remote command";
					Add_Remote_Triple_Page.AddRemoteIndicator.IsRunning = true;
		...
		{
			Device.BeginInvokeOnMainThread (() => {
				Add_Remote_Triple_Page.addRemotePageLayout.Children.Remove (Add_Remote_Triple_Page.plsWaitText);
