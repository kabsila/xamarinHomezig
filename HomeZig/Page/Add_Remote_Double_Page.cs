...
namespace HomeZig
{
	public class Add_Remote_Double_Page : ContentPage
	{
		...
		{
			Text = "Add new double remote command",
			FontAttributes = FontAttributes.Bold,
			FontSize = Device.GetNamedSize (NamedSize.Medium, typeof(Label)),
			HorizontalOptions = LayoutOptions.CenterAndExpand,
			VerticalOptions = LayoutOptions.EndAndExpand
		...
		public Add_Remote_Double_Page ()
		{
			addRemoteSubmitButton.Clicked += DependencyService.Get<I_Add_Remote_Double> ().submitRemoteButton_Click;		
			cancelRemoteButton.Clicked += DependencyService.Get<I_Add_Remote_Double> ().cancelRemoteButton_Click;
		...
		protected override void OnAppearing ()
		{
			...
			Add_Remote_Double_Page.plsWaitText.BackgroundColor = Color.Default;
			Add_Remote_Double_Page.plsWaitText.Text = "";
		}
		...
		protected override void OnDisappearing()
		{
			...
			Device.BeginInvokeOnMainThread (() => {
				...
				addRemotePageLayout.Children.Remove (Add_Remote_Double_Page.plsWaitText);
